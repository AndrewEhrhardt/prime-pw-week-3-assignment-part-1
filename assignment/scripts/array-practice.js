...
let favoriteFoods = ['Italian Sub', 'Ramen', 'Arepa']
...
favoriteFoods.push('Chicken Tikka Masala')
...
console.log('Removed the last food', favoriteFoods.pop())
...
favoriteFoods.unshift('Biscuits and Gravy')
console.log('Added a food to the beginning of the array', favoriteFoods)
